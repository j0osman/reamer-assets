...
Full reference: [docs](https://reamerlabs.com/docs) · The execution model behind the backtest itself: [execution specification](https://github.com/reamerlabs/Reamer/blob/main/EXECUTION_SPEC.md) · The workflow this maps onto: [reamerlabs.com](https://reamerlabs.com/#workflow)
