...
Each piece of good practice covered elsewhere in this tier — [specific hypotheses](https://reamerlabs.com/blog/intuition-to-testable-hypothesis), [honest experiment design](https://reamerlabs.com/blog/designing-a-good-trading-experiment), [a real discard bar](https://reamerlabs.com/blog/why-most-ideas-should-be-discarded), [a clean separation between iteration and validation](https://reamerlabs.com/blog/validation-vs-iteration), [deliberately extracting the reason behind a result](https://reamerlabs.com/blog/from-decision-to-knowledge) — is only actually repeatable once it stops being a decision made per idea and becomes a default applied to all of them. Always start with realistic costs. Always decide the acceptance bar before seeing the result. Always name the specific reason before moving to the next idea. None of these need to be reconsidered every time; deciding them once, and then simply applying them, is what repeatability actually looks like in practice.
